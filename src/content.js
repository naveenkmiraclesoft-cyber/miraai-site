...
const locales = {
  "en-US": {
    ...
    nav: ["Overview", "Business Value", "Platform", "Security", "Use Cases", "Resources"],
  ...
  fr: {
    ...
    nav: ["Aperçu", "Valeur métier", "Plateforme", "Sécurité", "Cas d'usage", "Ressources"], briefing: "Planifier une réunion de direction",
...
locales.de = derive(locales["en-US"], {
  ...
  nav: ["Überblick", "Geschäftswert", "Plattform", "Sicherheit", "Anwendungsfälle", "Ressourcen"], briefing: "Executive Briefing vereinbaren",
...
locales.ja = derive(locales["en-US"], {
  ...
  nav: ["概要", "ビジネス価値", "プラットフォーム", "セキュリティ", "ユースケース", "資料"], briefing: "エグゼクティブ・ブリーフィングを予約",
...
locales["zh-Hans"] = derive(locales["en-US"], {
  ...
  nav: ["概览", "业务价值", "平台", "安全", "应用场景", "资源"], briefing: "预约高管简报",
